...
class CommentTargetCreate(CommentCreate):
    """通用目标评论请求模型（article / hotspot）"""

    target_type: str = Field(..., description="评论目标类型：article / hotspot")
    target_id: int = Field(..., ge=1, description="评论目标 ID")
